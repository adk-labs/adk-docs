...
ADK의 사전 구축 [워크플로 에이전트](/adk-docs/ko/agents/workflow-agents/)인
[순차 에이전트](/adk-docs/ko/agents/workflow-agents/sequential-agents/) 같은
...
[ADK 2.0 설치](/adk-docs/ko/2.0/#install) 지침을 따른 뒤, 아래 내용을 통해
...
[워크플로 노드와 에이전트의 데이터 처리](/adk-docs/ko/workflows/data-handling/)를
참조하세요.
...
고급 그래프를 만드는 방법은
[워크플로 에이전트용 그래프 경로 구축](/adk-docs/ko/workflows/graph-routes/)을
참조하세요.
...
- **통합:** 일부 서드파티 [통합](/adk-docs/ko/integrations/)은 그래프 기반
