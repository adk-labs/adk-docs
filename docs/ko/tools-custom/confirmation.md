...
![도구 확인을 위한 기본 사용자 인터페이스 스크린샷](/ko/assets/confirmation-ui.png)
...
!!! note "참고: 재개 기능으로 확인"
    ...
    ADK 에이전트 워크플로가 
    [재개](/ko/runtime/resume/) 기능으로 구성된 경우 확인
...
-   [DatabaseSessionService](/ko/api-reference/python/google-adk.html#google.adk.sessions.DatabaseSessionService)는 이 기능에서 지원되지 않습니다.
-   [VertexAiSessionService](/ko/api-reference/python/google-adk.html#google.adk.sessions.VertexAiSessionService)는 이 기능에서 지원되지 않습니다.

## 다음 단계

에이전트 워크플로용 ADK 도구 빌드에 대한 자세한 내용은 [함수 도구](/ko/tools-custom/function-tools/)를 참조하십시오.
