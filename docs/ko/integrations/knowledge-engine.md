...
Knowledge Engine으로 Grounding을 사용할 경우 미리 RAG Corpus를 준비해야 합니다. 설정 방법은 [Knowledge Engine 페이지](https://cloud.google.com/vertex-ai/generative-ai/docs/rag-engine/rag-quickstart)를 참고하세요.
