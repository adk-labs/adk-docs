...
<div class="ceiling-section">
  <h2>개발자 커뮤니티</h2>
  <p class="section-subtitle">차세대 프로덕션용 AI 에이전트를 만드는 성장하는 개발자 커뮤니티와 함께하세요. 그래프 워크플로 문제를 해결하고 싶든, 커스텀 Agent Skill을 공유하고 싶든, 프레임워크의 미래를 함께 만들고 싶든, 여러분의 참여를 기다립니다.</p>
...
<!-- FEATURED: uncomment/comment cards to control which appear -->
    <a class="carousel-card" href="community/#adk-community-calls">
      ...
      <h3>커뮤니티 콜</h3>
      <p>ADK 핵심 엔지니어링 팀과 함께 라이브 데모, 기술 심화 세션, 로드맵 업데이트, Q&A에 참여하세요.</p>
      <span class="card-learn-more">자세히 보기 →</span>
    </a>
...
<!-- FEATURED: uncomment/comment cards to control which appear -->
    <a class="carousel-card" href="community/">
      ...
      <h3>개발자 자료</h3>
      <p>커뮤니티 구성원들이 만든 종합 학습 자료, 영상, 심화 콘텐츠로 학습 곡선을 줄여 보세요.</p>
      <span class="card-learn-more">자세히 보기 →</span>
    </a>
