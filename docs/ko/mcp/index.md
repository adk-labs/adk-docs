...
!!! tip "ADK용 MCP 도구"
    ...
    [도구 및 통합](/ko/integrations/?topic=mcp)을 참고하세요.
...
ADK에서 바로 사용할 수 있는 사전 구축 MCP 도구는 [도구 및 통합](/ko/integrations/)을 참고하세요. 또한 코드 샘플과 설계 패턴은 [MCP 도구 문서](/ko/tools-custom/mcp-tools/)를 참고하면, ADK를 MCP 서버와 함께 사용하는 방법을 확인할 수 있습니다. 여기에는 다음이 포함됩니다.
...
Cloud Run에서 실행되는 FastMCP 서버와 ADK를 함께 사용하는 방법은 [MCP 도구](/ko/tools-custom/mcp-tools/) 문서를 참고하세요.
