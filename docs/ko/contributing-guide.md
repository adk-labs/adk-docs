...
[`google/adk-docs`](https://github.com/google/adk-docs) | 현재 읽고 계신 문서 사이트의 소스를 포함합니다. | [`CONTRIBUTING.md`](https://github.com/google/blob/main/CONTRIBUTING.md)
...
* **문서 오류:** [`google/adk-docs`에 이슈 생성하기 (버그 템플릿 사용)](https://github.com/google/issues/new?template=bug_report.md)
...
* **문서 개선:** [`google/adk-docs`에 이슈 생성하기](https://github.com/google/issues/new)
...
* **위치:** [`google/adk-docs`에서 풀 리퀘스트 생성하기](https://github.com/google/pulls)
...
* **문서:** [`google/adk-docs`에서 풀 리퀘스트 생성하기](https://github.com/google/pulls)
...
기여함으로써 귀하는 귀하의 기여물이 프로젝트의 [Apache 2.0 라이선스](https://github.com/google/blob/main/LICENSE)에 따라 라이선스가 부여된다는 데 동의하게 됩니다.
