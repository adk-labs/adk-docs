...
-   :material-shopping-outline: **LensMosaic: ライブAIによるビジュアルショッピング**

    ---

    [![LensMosaic のスクリーンショット](https://raw.githubusercontent.com/kazunori279/lens-mosaic/main/assets/lens-mosaic-demo.png)](https://lens-mosaic-nhhfh7g7iq-uc.a.run.app)

    ライブカメラ入力、音声対話、インテリジェントな商品検索を組み合わせたデモアプリです。カメラを任意の物体に向けると類似商品を見つけられ、視覚と音声の入力を組み合わせてパーソナライズされたおすすめを取得したり、リアルタイムのAIショッピングアシスタントと会話したりできます。ADK Gemini Live API Toolkit、Gemini Embedding、Vector Search、FastAPI で構築されています。
