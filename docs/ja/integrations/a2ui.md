...
| サンプル | 説明 |
|---|---|
| [restaurant_finder](https://github.com/a2ui-project/a2ui/tree/main/samples/agent/adk/restaurant_finder) | レストラン情報を検索して表示する静的スキーマエージェントです |
| [rizzcharts](https://github.com/a2ui-project/a2ui/tree/main/samples/community/agent/adk/rizzcharts) | 文脈に応じてチャートコンポーネントを選択する動的カタログエージェントです |
| [orchestrator](https://github.com/a2ui-project/a2ui/tree/main/samples/community/agent/adk/orchestrator) | サブエージェントに処理を委譲し、UI 機能を集約するマルチエージェント構成です |
