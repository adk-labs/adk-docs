...
- [**ADK Dev Skills**](#adk-dev-skills): ADK 開発スキルをプロジェクトへ直接
  インストールします。
...
次を含む [GitHub 上の ADK Dev
Skills](https://github.com/google/tree/main/skills) を参照して
ください。
...
|------|-------------|-----|
| `llms.txt` | リンク付きのドキュメントインデックス | [`google.github.io/llms.txt`](https://adk.dev/llms.txt) |
| `llms-full.txt` | ドキュメント全体を 1 ファイルで提供 | [`google.github.io/llms-full.txt`](https://adk.dev/llms-full.txt) |
