...
質問がありますか。アイデアを共有したいですか。あるいは ADK の使い方について話したいですか。**[Python](https://github.com/google/adk-python/discussions)**、**[TypeScript](https://github.com/google/adk-js/discussions)**、**[Go](https://github.com/google/adk-go/discussions)**、**[Java](https://github.com/google/adk-java/discussions)** の Discussions へどうぞ。
