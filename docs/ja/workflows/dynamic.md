...
ADK フレームワークは、[グラフベースワークフロー](/adk-docs/ja/workflows/)の
...
[ADK 2.0 Alpha へようこそ](/adk-docs/ja/2.0/) を参照してください。
...
ADK で動的ワークフローを使う場合、
[グラフベースワークフロー](/adk-docs/ja/workflows/)よりもデータ受け渡しは
...
ADK の動的ワークフローは、
[グラフベースワークフロー](/adk-docs/ja/workflows/)と比べてルーティング
