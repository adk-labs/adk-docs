...
事前構築済みの ADK
[ワークフローエージェント](/adk-docs/ja/agents/workflow-agents/) である
[Sequential Agents](/adk-docs/ja/agents/workflow-agents/sequential-agents/)
...
[ADK 2.0 のインストール](/adk-docs/ja/2.0/#install) の手順に従い、その後で
...
[ワークフローノードとエージェントでのデータ処理](/adk-docs/ja/workflows/data-handling/)
を参照してください。
...
[ワークフローエージェントのグラフルートを構築する](/adk-docs/ja/workflows/graph-routes/)
を参照してください。
...
- **Integrations:** 一部のサードパーティ
  [Integrations](/adk-docs/ja/integrations/) は、グラフベースワークフローと
  互換性がない場合があります。
