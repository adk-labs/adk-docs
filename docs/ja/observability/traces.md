...
<div class="language-support-tag">
  <span class="lst-supported">ADKでサポート</span><span class="lst-python">Python v1.17.0</span><span class="lst-go">Go v1.0.0</span><span class="lst-kotlin">Kotlin v0.1.0</span>
</div>
...
Kotlinでは、ADKはグローバルな`GlobalOpenTelemetry`インスタンスを使用してトレースをエクスポートします。エージェントを起動する前にOpenTelemetry SDKを構成してください。
