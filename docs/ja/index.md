...
<!-- Framework -->
{{% include 'ja/_includes/homepage/_framework.md' %}}
...
<!-- Eval Section -->
{{% include 'ja/_includes/homepage/_eval.md' %}}

<!-- Ready to Build CTA Section -->
{{% include 'ja/_includes/homepage/_build-cta.md' %}}

<!-- Community Section -->
{{% include 'ja/_includes/homepage/_community.md' %}}

<!-- FAQ Section -->
{{% include 'ja/_includes/homepage/_faq.md' %}}
