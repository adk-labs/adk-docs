...
[`google/adk-docs`](https://github.com/google/adk-docs) | 現在ご覧になっているドキュメントサイトのソースが含まれています。 | [`CONTRIBUTING.md`](https://github.com/google/blob/main/CONTRIBUTING.md)
...
* **ドキュメントのエラー：** [`google/adk-docs`でIssueを作成（バグテンプレートを使用）](https://github.com/google/issues/new?template=bug_report.md)
...
* **ドキュメントの機能強化：** [`google/adk-docs`でIssueを作成](https://github.com/google/issues/new)
...
* **場所：** [`google/adk-docs`でプルリクエストを作成](https://github.com/google/pulls)
...
* **ドキュメント：** [`google/adk-docs`でプルリクエストを作成](https://github.com/google/pulls)
...
貢献することにより、あなたの貢献がプロジェクトの[Apache 2.0 ライセンス](https://github.com/google/blob/main/LICENSE)の下でライセンスされることに同意したことになります。
