...
=== "Typescript"
    ...
    const runner = new InMemoryRunner({
        ...
        artifactService: artifactService, // サービスはここで提供する必要があります
    });
...
*   **コード例:**
    ...
    === "Typescript"
        ...
        async function saveGeneratedReport(context: Context, reportBytes: Uint8Array): Promise<void> {
            /**生成された PDF レポートのバイトをアーティファクトとして保存します。*/
            ...
            try {
                ...
                console.error(`TypeScript アーティファクトの保存エラー: ${e.message}。Runner に ArtifactService が設定されていますか？`);
            }
        }
        ```
    ...
    === "Typescript"
        ...
        async function processLatestReport(context: Context): Promise<void> {
            ...
            try {
                ...
                console.error(`TypeScript アーティファクトの読み込みエラー: ${e.message}。ArtifactService が設定されていますか？`);
            }
        }
        ```
    ...
    === "Typescript"
        ...
        async function listUserFiles(context: Context): Promise<string> {
            ...
            try {
                ...
                console.error(`TypeScript アーティファクトの一覧取得エラー: ${e.message}。ArtifactService が設定されていますか？`);
