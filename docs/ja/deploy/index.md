...
[エージェント エンジン](agent-engine/index.md) は、ADK などのフレームワークで構築された AI エージェントのデプロイ、管理、スケーリングのために特別に設計された、Google Cloud 上のフルマネージドの自動スケーリング サービスです。

[Vertex AI エージェント エンジンへのエージェントのデプロイ](agent-engine/index.md) の詳細をご覧ください。
