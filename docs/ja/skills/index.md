...
<div class="language-support-tag">
    <span class="lst-supported">ADKでサポート</span><span class="lst-python">Python v1.25.0</span><span class="lst-typescript">TypeScript v0.6.1</span><span class="lst-go">Go v1.2.0</span><span class="lst-preview">実験的</span>
</div>
...
## TypeScript Skills 例の補足

英語原文に含まれている TypeScript Skills 例を以下にも掲載します。
