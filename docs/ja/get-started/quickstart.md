...
!!!tip "モデル認証ガイド"
    さまざまなモデルの認証に関する詳細なガイドについては、[認証ガイド](../agents/models.md#google-ai-studio)を参照してください。
...
* **高度な構成を深く掘り下げる:** プロジェクト構造、構成、その他のインターフェースの詳細については、[セットアップ](installation.md)セクションを参照してください。
