...
2.  **`VertexAiSessionService`**
    ...
    *   **永続性:** あり。データは[Vertex AI Agent Engine](https://adk.dev/deploy/agent-engine/)を介して信頼性が高く、スケーラブルに管理されます。
    *   **要件:**
        ...
        *   この[チュートリアル](https://adk.dev/deploy/agent-engine/)に従って設定できるReasoning Engineのリソース名/ID。
