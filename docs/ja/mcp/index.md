...
!!! tip "ADK 用の MCP ツール"
    ...
    [Tools and Integrations](/adk-docs/integrations/?topic=mcp) を参照してください。
...
[MCP Tools documentation](/adk-docs/ja/tools-custom/mcp-tools/) を参照してください。
ここには次が含まれます。
...
[MCP Tools](/adk-docs/ja/tools-custom/mcp-tools/) を参照してください。
