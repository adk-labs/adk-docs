...
- [**グラフベースのワークフロー**](/adk-docs/ja/workflows/): タスクの
  ルーティングと実行方法をより細かく制御できる、決定論的なエージェント
  ワークフローを構築します。
- [**協調エージェント**](/adk-docs/ja/workflows/collaboration/):
  コーディネーターエージェントと複数のサブエージェントが連携する複雑な
  エージェントアーキテクチャを構築します。
- [**動的ワークフロー**](/adk-docs/ja/workflows/dynamic/): 反復ループや
...
- [**グラフベースのワークフロー**](/adk-docs/ja/workflows/)
- [**協調エージェント**](/adk-docs/ja/workflows/collaboration/)
- [**動的ワークフロー**](/adk-docs/ja/workflows/dynamic/)
