...
<div class="hero-grid">
  <div class="hero-content">
    <h1>プロトタイプではなく<span class="hero-punchline">本番用エージェントを構築しましょう。</span></h1>
    <p>ADK は、信頼できる AI エージェントをエンタープライズ規模で構築、デバッグ、デプロイするためのオープンソースのエージェント開発フレームワークです。Python、TypeScript、Go、Java、Kotlin に対応しています。</p>
    <div class="hero-actions">
      <a href="get-started/" class="btn btn-primary">始める</a>
      <!-- <a href="skills/" class="btn btn-accent">エージェントスキル</a> -->
    </div>
  </div>
